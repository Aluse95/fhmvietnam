...
<script src="{{ asset('themes/frontend/fhmvietnam/js/service.js') }}"></script>
<script src="{{ asset('themes/frontend/fhmvietnam/js/service-mobile.js') }}"></script>
<script src="{{ asset('themes/frontend/fhmvietnam/js/menu.js') }}"></script>
<script src="{{ asset('themes/frontend/fhmvietnam/js/jquery.js') }}"></script>
<script src="{{ asset('themes/frontend/fhmvietnam/js/lazysizes.min.js') }}"></script>
<script src="{{ asset('themes/frontend/fhmvietnam/js/custom.js') }}"></script>
